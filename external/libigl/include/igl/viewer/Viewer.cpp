...
namespace viewer
{
  ...
  //  nanogui::Window *window = ngui->addWindow(Eigen::Vector2i(10,10),"Basic");
  ...
  IGL_INLINE int  Viewer::launch_init(bool resizable,bool fullscreen)
  {
    ...
    if(fullscreen)
    {
      ...
      window = glfwCreateWindow(mode->width,mode->height,"suMesh Designer",monitor,nullptr);
    }
    else
    {
      window = glfwCreateWindow(1280,800,"suMesh Designer",nullptr,nullptr);
    }
